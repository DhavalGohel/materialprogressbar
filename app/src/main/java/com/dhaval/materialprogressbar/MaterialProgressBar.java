...
public class MaterialProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar, defStyleAttr, 0);


        final float density = getContext().getResources().getDisplayMetrics().density;

        mBackGroundColor = a.getColor(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_background_color, DEFAULT_CIRCLE_BG_LIGHT);

        mProgressColor = a.getColor(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_progress_color, DEFAULT_CIRCLE_BG_LIGHT);//ToDO 默认颜色

        mInnerRadius = a.getDimensionPixelOffset(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_inner_radius, -1);

        mProgressStokeWidth = a.getDimensionPixelOffset(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_progress_stoke_width, (int) (STROKE_WIDTH_LARGE * density));
        mArrowWidth = a.getDimensionPixelOffset(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_arrow_width, -1);
        mArrowHeight = a.getDimensionPixelOffset(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_arrow_height, -1);
        mTextSize = a.getDimensionPixelOffset(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_progress_text_size, (int) (DEFAULT_TEXT_SIZE * density));
        mTextColor = a.getColor(
                srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_progress_text_color, Color.BLACK);

        mShowArrow = a.getBoolean(srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_show_arrow, false);
        mCircleBackgroundEnabled = a.getBoolean(srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_enable_circle_background, true);


        mProgress = a.getInt(srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_progress, 0);
        mMax = a.getInt(srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_max, 100);
        int textVisible = a.getInt(srtpl.com.materialprogressbar.R.styleable.MaterialProgressBar_progress_text_visibility, 1);
        if (textVisible != 1) {
            mIfDrawText = true;
        }
